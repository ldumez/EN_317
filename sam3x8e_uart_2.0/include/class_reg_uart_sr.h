#ifndef class_reg_uart_sr_h
#define class_reg_uart_sr_h

#include "../include/class_reg_32.h"

class class_reg_uart_sr : public class_reg_32 //Interrupt Enable Register
	{
		public:
		...
		//private:
			...
			int rxbuff;				// 1 bit : 1
			const int mask_rxbuff = 0x1000;	// 0x1000;
			const int start_rxbuff = 12;	// 12;
};
#endif
